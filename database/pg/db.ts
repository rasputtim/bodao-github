...
export type SQLDBStatus_t = typeof SQLDBStatus[keyof typeof SQLDBStatus];
...
export default class Database{
    ...
    theServer
    Knex
    private static _sqlDdatabaseStatus: SQLDBStatus_t = SQLDBStatus.UNKNOWN
    ...
    get status(): SQLDBStatus_t { return Database._sqlDdatabaseStatus }
    static set status(v: SQLDBStatus_t) { Database._sqlDdatabaseStatus = v}
    /**
      ...
      /**
       ...
       Knexfunction.QueryBuilder.extend('cache', function (databaseObj) {
        try {
            ...
            if (cacheSize > 10000) databaseObj.clearCache();
            const obj:any = {};
     ...
     */
    sql_error_handler ()/*$errno, $errstr)*/ {
