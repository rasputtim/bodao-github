...
const data = {
    ...
    rafael: {
        ...
        paymentmethods: {
            ...
            the_R_tableName: Macfacil.MacFacilTable.ITesPaymentMethod,
            the_J_tableName: Macfacil.MacFacilTable.ITesPaymentDetail,
            the_J_FK_to_R_table: 'method_id',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
        },
        data: {
...
export default data;
//# sourceMappingURL=ttes_payment_detail.db.config.js.map