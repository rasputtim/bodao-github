...
export const fieldSchemas = {
    ...
    insert_payload: Joi.object({
        ...
        column: Joi.string().required().valid('address_context', 'address_type', 'payment_method', 'telephone_type', 'tes_category', 'tes_user_category', 'id_grade_ct', 'user_profile', 'id_relationship_ct', 'user_role', 'id_relationship_ct', 'download_type', 'download_category', 'company_role', 'telephone_context'),
    ...
    edit_payload: Joi.object({
        ...
        column: Joi.string().optional().valid('address_context', 'address_type', 'payment_method', 'telephone_type', 'tes_category', 'tes_user_category', 'id_grade_ct', 'user_profile', 'id_relationship_ct', 'user_role', 'id_relationship_ct', 'download_type', 'download_category', 'company_role', 'telephone_context'),
...
export default data;
//# sourceMappingURL=tcommon_lookup.db.config.js.map