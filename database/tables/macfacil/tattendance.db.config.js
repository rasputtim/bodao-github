...
const data = {
    ...
    rafael: {
        ...
        agendas: {
            ...
            the_J_tableName: dbSchemas.RAFAEL + '.' + 'tattendance',
            the_J_FK_to_R_table: 'id_agenda',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
        },
        users: {
            ...
            the_J_tableName: dbSchemas.RAFAEL + '.' + 'tattendance',
            the_J_FK_to_R_table: 'id_contact',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
        },
        usercontacts: {
            the_R_tableType: { thisTableClass: tableClass.M_TABLE, relationshipWithObjKey: relationshipType.M_to_M },
            the_R_tableName: dbSchemas.RAFAEL + '.' + 'tusuario_contact',
            the_J_tableName: dbSchemas.RAFAEL + '.' + 'tattendance',
            the_J_FK_to_R_table: 'id_contact',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
        ...
        visitors: {
            the_R_tableType: { thisTableClass: tableClass.M_TABLE, relationshipWithObjKey: relationshipType.M_to_M },
            the_R_tableName: dbSchemas.RAFAEL + '.' + 'tvisitor',
            the_J_tableName: dbSchemas.RAFAEL + '.' + 'tattendance',
            the_J_FK_to_R_table: 'id_contact',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
        ...
        companies: {
            the_R_tableType: { thisTableClass: tableClass.M_TABLE, relationshipWithObjKey: relationshipType.M_to_M },
            the_R_tableName: dbSchemas.RAFAEL + '.' + 'tcompany',
            the_J_tableName: dbSchemas.RAFAEL + '.' + 'tattendance',
            the_J_FK_to_R_table: 'id_contact',
            the_J_primKey: 'id',
            the_R_primKey: 'id'
...
export default data;
//# sourceMappingURL=tattendance.db.config.js.map