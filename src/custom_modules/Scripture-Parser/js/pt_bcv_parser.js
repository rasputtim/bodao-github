...
regexps.translations = /(?:(?:BPT|JFA|NVI))\b/gi;
regexps.space = "[\\s\\xa0]";
regexps.escaped_passage = RegExp("(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|t[íi]tulo(?![a-z])|e(?!" + regexps.space + "+sig)|e" + regexps.space + "+sig|vers[íi]culos|cap[íi]tulos|vers[íi]culo|cap[íi]tulo|caps|vers|cap|ver|vss|vs|vv|á|v|[a-d](?!\\w)|$)+)", "gi");
regexps.match_end_split = RegExp("\\d\\W*t[íi]tulo|\\d\\W*e" + regexps.space + "+sig(?:[\\s\\xa0*]*\\.)?|\\d[\\s\\xa0*]*[a-d](?!\\w)|\\x1e(?:[\\s\\xa0*]*[)\\]\\uff09])?|[\\d\\x1f]", "gi");
regexps.control = /[\x1e\x1f]/g;
regexps.pre_book = "[^A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ]";
regexps.first = "(?:Primeir[ao]|1[ao]?|I)\\.?" + regexps.space + "*";
regexps.second = "(?:Segund[ao]|2[ao]?|II)\\.?" + regexps.space + "*";
regexps.third = "(?:Terceir[ao]|3[ao]?|III)\\.?" + regexps.space + "*";
regexps.range_and = "(?:[&\u2013\u2014-]|e(?!" + regexps.space + "+sig)|á)";
regexps.range_only = "(?:[\u2013\u2014-]|á)";
regexps.get_books = (include_apocrypha, case_sensitive) => {
    ...
    books = [
        {
            ...
            osis: ["Gen"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:G(?:[e\\xE9\\xEA]n(?:esis)?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Exod"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:[E\\xCA]x(?:o(?:do?)?|d)?|\\xC9xodo))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Bel"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Bel(?:[\\s\\xa0]*e[\\s\\xa0]*o[\\s\\xa0]*[Dd]rag[a\\xE3]o)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Lev"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:L(?:e(?:v(?:[i\\xED]ticos?)?)?|v)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Num"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:N(?:[u\\xFA](?:m(?:eros)?)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Sir"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Sir(?:[a\\xE1]cida)?|Eclesi[a\\xE1]stico))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Wis"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:S(?:ab(?:edoria(?:[\\s\\xa0]*de[\\s\\xa0]*Salom[a\\xE3]o)?)?|b)|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Lam"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:L(?:am(?:enta[c\\xE7](?:[o\\xF5]es(?:[\\s\\xa0]*de[\\s\\xa0]*Jeremias)?|\\xF4es[\\s\\xa0]*de[\\s\\xa0]*Jeremias))?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["EpJer"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Cart(?:a[\\s\\xa0]*de[\\s\\xa0]*Jeremias|\\.?[\\s\\xa0]*Jer)|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Rev"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ap(?:oc(?:alipse(?:[\\s\\xa0]*de[\\s\\xa0]*(?:S[a\\xE3]o[\\s\\xa0]*Jo[a\\xE3]|Jo[a\\xE3])o)?)?|c)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["PrMan"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Pr(?:ece[\\s\\xa0]*de[\\s\\xa0]*Manass[e\\xE9]s|[\\s\\xa0]*?Man)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Deut"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:D(?:eu(?:t(?:eron[o\\xF3\\xF4]mio)?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Josh"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:os(?:u[e\\xE9]|h)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Judg"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:u(?:[i\\xED]z(?:es)?|dg)|z)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Ruth"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:R(?:u(?:t[eh]?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["2Esd"],
            apocrypha: true,
            ...
            osis: ["Isa"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Is(?:a(?:[i\\xED]as)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["2Sam"],
            ...
            osis: ["Ezra"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:E(?:sd(?:r(?:as)?)?|zra|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Neh"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ne(?:emias|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["GkEsth"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Est(?:er[\\s\\xa0]*(?:\\([Gg]rega\\)|[Gg]rega)|[\\s\\xa0]*\\(Gr\\))|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Esth"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:E(?:st(?:er|h)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Job"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:\\xF3|ob)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["PrAzar"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Sal(?:mo[\\s\\xa0]*de[\\s\\xa0]*Azarias|[\\s\\xa0]*Azar)|PrAzar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Ps"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:S(?:al(?:mos?)?|l)|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Prov"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:P(?:r(?:o(?:v(?:[e\\xE9]rbios)?)?|v)?|v)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Eccl"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ec(?:l(?:esiastes)?|cl)?|Co[e\\xE9]let))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["SgThree"],
            apocrypha: true,
            ...
            osis: ["Song"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:C(?:ant(?:ico(?:[\\s\\xa0]*(?:(?:de[\\s\\xa0]*Salom[a\\xE3]|Superlativ)o|dos[\\s\\xa0]*C[a\\xE2]nticos)|s[\\s\\xa0]*dos[\\s\\xa0]*C[a\\xE2]nticos)|ares[\\s\\xa0]*de[\\s\\xa0]*Salom[a\\xE3]o)?|\\xE2ntico(?:[\\s\\xa0]*(?:(?:de[\\s\\xa0]*Salom[a\\xE3]|Superlativ)o|dos[\\s\\xa0]*C[a\\xE2]nticos)|s[\\s\\xa0]*dos[\\s\\xa0]*C[a\\xE2]nticos)|(?:\\xE2n|n)?t)|Song)|(?:C(?:ant(?:are|ico)|\\xE2ntico)s))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Jer"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:e(?:r(?:emias)?)?|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Ezek"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ez(?:e(?:q(?:uiel)?|k)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Dan"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:D(?:a(?:n(?:iel)?)?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Hos"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Os(?:[e\\xE9]ias)?|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Joel"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:oe)?l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Amos"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Am(?:[o\\xF3]s)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Obad"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ob(?:a(?:d(?:ias)?)?|d)?|Abd(?:ias)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Jonah"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:on(?:a[hs])?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Mic"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:M(?:i(?:q(?:u[e\\xE9]ias)?|c)|q)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Nah"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Na(?:um|h)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Hab"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:H(?:ab(?:acu(?:que|c))?|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Zeph"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:S(?:of(?:onias)?|f)|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Hag"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Ag(?:eu)?|Hag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Zech"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Z(?:ac(?:arias)?|ech|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Mal"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:M(?:al(?:aquias)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Matt"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:M(?:at(?:eus|t)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["1Macc"],
            apocrypha: true,
            ...
            osis: ["Mark"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:M(?:ar(?:cos|k)|r?c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Luke"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:L(?:u(?:c(?:as)?|ke)|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["1John"],
            ...
            osis: ["John"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Jo(?:[a\\xE3]o|hn)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Acts"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:A(?:t(?:os(?:[\\s\\xa0]*dos[\\s\\xa0]*Ap[o\\xF3]stolos)?)?|cts)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Rom"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:R(?:o(?:m(?:anos)?)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["2Cor"],
            ...
            osis: ["Gal"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:G(?:[a\\xE1]l(?:atas)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Eph"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:E(?:f(?:[e\\xE9]sios)?|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Phil"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:F(?:il(?:ipenses)?|[lp])|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Col"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:C(?:ol(?:ossenses)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["2Thess"],
            ...
            osis: ["Titus"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:T(?:it(?:us|o)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Phlm"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:F(?:il(?:emo[mn]|\\xE9mon)|l?mn|l?m)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Heb"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:H(?:eb(?:reus)?|b)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Jas"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:T(?:iago|g)|Jas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["2Pet"],
            ...
            osis: ["Jude"],
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:ud(?:as|e)?|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Tob"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Tob(?:ias)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Jdt"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:J(?:udite|dt)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Bar"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Bar(?:u(?:[ck]|que))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }, {
            osis: ["Sus"],
            apocrypha: true,
            regexp: RegExp("(^|" + regexps.pre_book + ")((?:Hist[o\\xF3]ria[\\s\\xa0]*de[\\s\\xa0]*Susana|Sus(?:ana)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
        }
    ];
...
regexps.books = regexps.get_books(false, "none");
export default class bcv_parser {
    ...
    get translations() { return bcv_parser._translations; }
    get languages() { return bcv_parser._languages; }
    parse(s) {
        var ref;
        this.reset();
        this.s = s;
    ...
    include_apocrypha(arg) {
        ...
        regexps.books = regexps.get_books(arg, this.options.case_sensitive);
        ref = this.translations;
        for (translation in ref) {
            if (!hasProp.call(ref, translation))
                continue;
    ...
    case_sensitive(arg) {
        ...
        regexps.books = regexps.get_books(this.options.include_apocrypha, arg);
        return this;
    }
    ;
    ...
    match_books(s) {
        ...
        s = s.replace(regexps.translations, function (match) {
            books.push({
                value: match,
    ...
    match_passages(s) {
        ...
        while (match = regexps.escaped_passage.exec(s)) {
            ...
            var grammar2 = grammar.getInstance().parse;
            passage = {
                value: grammar2(part, {
            ...
            if (regexp_index_adjust > 0) {
                regexps.escaped_passage.lastIndex -= regexp_index_adjust;
            }
        }
...
class grammar {
    constructor() {
        this.peg$SyntaxError = (message, expected, found, location) => {
        ...
        this.peg$parse = (input, options) => {
            ...
            const expected = (description, location) => {
            ...
            const peg$literalExpectation = (text, ignoreCase) => {
                return { type: "literal", text: text, ignoreCase: ignoreCase };
            };
            const peg$classExpectation = (parts, inverted, ignoreCase) => {
                return { type: "class", parts: parts, inverted: inverted, ignoreCase: ignoreCase };
            };
            const peg$anyExpectation = () => {
                return { type: "any" };
            };
            const peg$endExpectation = () => {
                return { type: "end" };
            };
            const peg$otherExpectation = (description) => {
                return { type: "other", description: description };
            };
            const peg$computePosDetails = (pos) => {
            ...
            const peg$computeLocation = (startPos, endPos) => {
            ...
            const peg$buildSimpleError = (message, location) => {
                return new peg$SyntaxError(message, null, null, location);
            };
            const peg$buildStructuredError = (expected, found, location) => {
                return new peg$SyntaxError(peg$SyntaxError.buildMessage(expected, found), expected, found, location);
            };
            const peg$parsestart = () => {
                var s0, s1;
                s0 = [];
            ...
            const peg$parsesequence_post_enclosed = () => {
            ...
            const peg$parsebcv_hyphen_range = () => {
                var s0, s1, s2, s3, s4, s5, s6, s7;
                s0 = peg$currPos;
                s1 = peg$parseb();
                if (s1 !== peg$FAILED) {
            ...
            const peg$parsetranslation_sequence_enclosed = () => {
                var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
                s0 = peg$currPos;
                s1 = peg$parsesp();
                if (s1 !== peg$FAILED) {
            ...
            const peg$parsetranslation_sequence = () => {
                var s0, s1, s2, s3, s4, s5, s6, s7, s8;
                s0 = peg$currPos;
                s1 = peg$parsesp();
                if (s1 !== peg$FAILED) {
            ...
            const peg$parseword_parenthesis = () => {
                var s0, s1;
                s0 = peg$currPos;
                if (peg$c110.test(input.charAt(peg$currPos))) {
    ...
    static getInstance() {
        //grammar.peg$subclass(this.peg$SyntaxError, Error);
        let instance = new grammar();
        return instance;
    }
    get SyntaxError() { return this.peg$SyntaxError; }
    get parse() {
        var p = this.peg$parse;
        return p;
    }
}
grammar.peg$subclass = (child, parent) => {
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
    child.prototype = new ctor();
};
//# sourceMappingURL=pt_bcv_parser.js.map