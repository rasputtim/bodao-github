 ...
 */
exports.getFunctions = (html5playerfile, options) => exports.cache.getOrSet(html5playerfile, () => __awaiter(void 0, void 0, void 0, function* () {
    const body = yield utils.exposedMiniget(html5playerfile, options).text();
 ...
 * @param {Object} options
 */
exports.decipherFormats = (formats, html5player, options) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let decipheredFormats = {};
        let functions = yield exports.getFunctions(html5player, options);
